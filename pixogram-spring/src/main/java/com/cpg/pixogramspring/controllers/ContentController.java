...
public class ContentController {
	...
	public ResponseEntity<String> uploadFile(
			...
			@ApiParam(value = "ID value for the user you want to upload for", required = true) @RequestParam("user_id") String user_id)
			throws IllegalStateException, IOException {
		int user__id= Integer.parseInt(user_id);
		Content content = contentService.uploadFile(file, caption, user__id);
//		Message message= new Message();
//		message.setUser(userService.getUserById(user__id));
		if (content != null) {
...
//			@ApiParam(value = "Select a file you want to upload", required = true) @RequestParam("file") MultipartFile file)
//			throws IllegalStateException, IOException {
//		String content = contentService.storeFile(file);
...
//.........................................USER METHODS ON CONTENTS...................................................//
	...
	public ResponseEntity<Message> addComment(
		...
		//	message.setComments(comments);
			...
			message.setText(UserConstants.commentNotExists);
			message.setContents(contents);
			//message.setComments(comments);
	...
	public ResponseEntity<Message> addLike(
...
//		System.out.println(count);
		...
		if (content != null) {
			...
			message.setText(UserConstants.contentNotExists);
			message.setContents(contents);
			return new ResponseEntity<>(message, HttpStatus.NOT_FOUND);
		}
	}
	...
	public ResponseEntity<Message> addDislike(
			@ApiParam(value = "ID value for the user you want to delete", required = true) @RequestParam("user_id") int user_id,

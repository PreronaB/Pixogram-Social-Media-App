...
export default class UploadFiles extends Component {
  ...
  selectFile(event) {
    this.setState({
      ...
      selectedFiles: URL.createObjectURL(event.target.files[0]),
      caption : this.caption.current.value,
      user_id : localStorage.getItem('user_id')
      // filename : this.filename.current.value
    });
  }
              ...
              <div className='card-body'>
                <form>
                  <div className='form-group'>
                    ...
                    {/* <div className="mb-3">
                      <label forname="exampleFormControlInput2" className="form-label">FileName</label>
                      <input type="text" name="user_id" ref={this.filename} className="form-control" id="exampleFormControlInput2" placeholder="Enter File Name" />
                    </div> */}

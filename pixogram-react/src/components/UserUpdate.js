...
class UserUpdate extends Component {
    ...
    setInput() {
        this.setState({
            user_id: this.props.users.user_id,
                                    ...
                                    <Form.Row>
                                        <Form.Group as={Col}>
                                            <InputGroup>
                                                ...
                                                <FormControl autoComplete="off" type="text" name="user_id" ref={this.user_id} value={localStorage.getItem('user_id')} onChange={this.onChange}
                                    ...
                                    <Form.Row>
                                        <Form.Group as={Col}>
                                            <InputGroup>
                                                ...
                                                <FormControl autoComplete="off" type="text" name="username" ref={this.username} value={localStorage.getItem('userUsername')}
                                    ...
                                    <Form.Row>
                                        <Form.Group as={Col}>
                                            <InputGroup>
                                                ...
                                                <FormControl required autoComplete="off" type="text" name="email" ref={this.email} value={localStorage.getItem('userEmail')}
                                    ...
                                    <Form.Row>
                                        <Form.Group as={Col}>
                                            <InputGroup>
                                                ...
                                                <FormControl required autoComplete="off" type="password" name="password" ref={this.password} value={localStorage.getItem('userPassword')}
                                    ...
                                    <Form.Row>
                                        <Form.Group as={Col}>
                                            <InputGroup>
                                                ...
                                                <FormControl required autoComplete="off" type="text" name="gender" ref={this.gender} value={localStorage.getItem('userGender')}
                                    ...
                                    <Form.Row>
                                        <Form.Group as={Col}>
                                            <InputGroup>
                                                ...
                                                <FormControl required autoComplete="off" type="text" name="state" ref={this.state} value={localStorage.getItem('userState')}
                                    ...
                                    <Form.Row>
                                        <Form.Group as={Col}>
                                            <InputGroup>
                                                ...
                                                <FormControl required autoComplete="off" type="text" name="bio" ref={this.bio} value={localStorage.getItem('userBio')}
                                                    onChange={this.onChange} className={"bg-white text-dark"} placeholder="Enter Bio" />
                                            </InputGroup>
                                        </Form.Group>
                                    </Form.Row>
                                    <Form.Row>{' '}
                                        <Form.Control as="select" className="mr-sm-2" id="inlineFormCustomSelect" ref={this.role} value={this.state.role} onChange={this.onChange} custom>

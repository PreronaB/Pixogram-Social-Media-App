...
//                                     </InputGroup.Prepend>
//                                     <FormControl required type="text" name="user_id" value={localStorage.getItem('user_id')}
//                                         ref={this.user_id} className={"bg-white text-black"} placeholder="Enter user id" />
//                                 </InputGroup>
//                             </Form.Group>
//                         </Form.Row>
...
//                                       value={localStorage.getItem('userEmail')}  className={"bg-white text-black"} placeholder="Enter emailid of user you want to follow" />
//                                 </InputGroup>
//                             </Form.Group>
//                         </Form.Row>
